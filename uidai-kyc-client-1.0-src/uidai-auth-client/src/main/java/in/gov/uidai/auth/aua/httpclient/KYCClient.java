...
public class KYCClient {
	...
	public String kycTrans(Auth auth, String kua, boolean isRcReceived,
		...
		try {
			...
			// TODO: TWEAKS: Since we are having 
			...
			e.printStackTrace();
			/*System.out.println(new RuntimeException("Exception during KYC transaction "
					+ e.getMessage());*/
		}
		finally {
			// TODO: TWEAKS: Since we are having time out issue, we will return null string for time being
			return "";
		}
